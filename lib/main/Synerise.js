...
var modulesToCreate = [ModuleIdentifier.SETTINGS, ModuleIdentifier.CLIENT, ModuleIdentifier.TRACKER, ModuleIdentifier.NOTIFICATIONS,
    ModuleIdentifier.INJECTOR, ModuleIdentifier.PROMOTIONS, ModuleIdentifier.CONTENT];
var SyneriseModuleController = /** @class */ (function () {
    ...
    SyneriseModuleController.prototype.getModule = function (moduleIdentifier) {
        ...
        if (moduleInstance != undefined && moduleInstance.isActive == true) {
            ...
            console.error("Synerise ".concat(this.getModuleName(moduleIdentifier), " module is not available now."));
        }
    };
...
var Synerise = /** @class */ (function () {
    ...
    Synerise.isInitialized = function () {
        return SyneriseInitializer.isSyneriseInitialized();
    };
