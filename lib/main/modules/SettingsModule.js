...
function mapSettingsOptionsForNativeModule(settingsOptions) {
    return {
        ...
        SDK_DO_NOT_TRACK: settingsOptions.sdk && settingsOptions.sdk.doNotTrack,
...
function setInitialSettings(settingsOptions) {
    var settingsManyOptions = mapSettingsOptionsForNativeModule(settingsOptions);
    SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethod(RNSettings.setInitialSettings, [settingsManyOptions]);
}
function getOne(key) {
...
var SettingsModule = /** @class */ (function (_super) {
    ...
    function SettingsModule() {
        ...
        _this.sdk = {
            ...
            get doNotTrack() {
                return getOne(RNSettings.SDK_DO_NOT_TRACK);
            },
            set doNotTrack(value) {
                setOne(RNSettings.SDK_DO_NOT_TRACK, value);
            },
    ...
    SettingsModule.prototype.set = function (settingsOptions) {
        setInitialSettings(settingsOptions);
    };
