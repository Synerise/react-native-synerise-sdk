...
function mapOptionsToObject(options) {
    var object = {
        SDK_ENABLED: options.sdk && options.sdk.enabled,
        SDK_MIN_TOKEN_REFRESH_INTERVAL: options.sdk && options.sdk.minTokenRefreshInterval,
        TRACKER_MIN_BATCH_SIZE: options.tracker && options.tracker.minBatchSize,
        TRACKER_MAX_BATCH_SIZE: options.tracker && options.tracker.maxBatchSize,
        TRACKER_AUTO_FLUSH_TIMEOUT: options.tracker && options.tracker.autoFlushTimeout,
        NOTIFICATIONS_ENABLED: options.notifications && options.notifications.enabled,
        NOTIFICATIONS_DISABLE_IN_APP_ALERTS: options.notifications && options.notifications.disableInAppAlerts,
        NOTIFICATIONS_APP_GROUP_IDENTIFIER: options.notifications && options.notifications.appGroupIdentifier
    };
    return object;
}
function getOne(key) {
