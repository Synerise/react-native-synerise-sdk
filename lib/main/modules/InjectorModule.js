...
var InjectorModule = /** @class */ (function (_super) {
    ...
    function InjectorModule() {
        ...
        _this.onInAppMessageCustomMethod = function (event) {
        ...
        _this.inAppContext = _this.createInAppContextProxy();
    ...
    InjectorModule.prototype.createInAppContextProxy = function () {
        var _this = this;
    ...
    InjectorModule.prototype.pushInAppContext = function () {
