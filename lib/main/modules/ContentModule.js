...
var ContentModule = /** @class */ (function (_super) {
    ...
    ContentModule.prototype.generateDocumentWithApiQuery = function (apiQuery, onSuccess, onError) {
        ...
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNContent.generateDocumentWithApiQuery, [apiQueryObject], onSuccess, onError, BaseModel_1.ModelMapper.make(Document_1.Document));
    };
    /**
    ...
    ContentModule.prototype.generateScreenViewWithApiQuery = function (apiQuery, onSuccess, onError) {
        var apiQueryObject = apiQuery.toObject();
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNContent.generateScreenViewWithApiQuery, [apiQueryObject], onSuccess, onError, BaseModel_1.ModelMapper.make(ScreenView_1.ScreenView));
    };
    /**
     ...
     *
     */
    ContentModule.prototype.generateBrickworks = function (apiQuery, onSuccess, onError) {
        var apiQueryObject = apiQuery.toObject();
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNContent.generateBrickworks, [apiQueryObject], onSuccess, onError);
    };
