...
var PromotionsModule = /** @class */ (function (_super) {
    ...
    PromotionsModule.prototype.getPromotions = function (apiQuery, onSuccess, onError) {
        var apiQueryObject = apiQuery.toObject();
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNPromotions.getPromotions, [apiQueryObject], onSuccess, onError, BaseModel_1.ModelMapper.make(PromotionResponse_1.PromotionResponse));
    };
    /**
     ...
     *
     */
    PromotionsModule.prototype.activatePromotion = function (options, onSuccess, onError) {
        var optionsObject = options.toObject();
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNPromotions.activatePromotion, [optionsObject], onSuccess, onError, BaseModel_1.ModelMapper.make(Promotion_1.Promotion));
    };
    /**
    ...
    PromotionsModule.prototype.activatePromotionsBatch = function (promotionsIdentifiers, onSuccess, onError) {
        var promotionIdentifiersArray = promotionsIdentifiers.map(function (promotionIdentifier) {
            return promotionIdentifier.toObject();
        });
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNPromotions.activatePromotionsBatch, [promotionIdentifiersArray], onSuccess, onError);
    };
    /**
    ...
    PromotionsModule.prototype.deactivatePromotionsBatch = function (promotionsIdentifiers, onSuccess, onError) {
        ...
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNPromotions.deactivatePromotionsBatch, [promotionIdentifiersArray], onSuccess, onError);
    };
    /**
