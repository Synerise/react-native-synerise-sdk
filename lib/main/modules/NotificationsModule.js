...
var NotificationsModule = /** @class */ (function (_super) {
    ...
    function NotificationsModule() {
        ...
        _this.onNotification = function (event) {
            if (_this.listener !== undefined && _this.listener.onNotification !== undefined) {
    ...
    NotificationsModule.prototype.handleNotification = function (payload, actionIdentifier) {
        if (DeviceUtils_1.DeviceUtils.isPlatformIOS()) {
            if (actionIdentifier != null) {
                SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethod(RNSyneriseNotifications.handleNotificationWithAction, [payload, actionIdentifier]);
            }
            else {
