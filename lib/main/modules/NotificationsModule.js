...
var RNSyneriseNotifications = react_native_1.NativeModules.RNSyneriseNotifications;
var NotificationsModule = /** @class */ (function (_super) {
    ...
    NotificationsModule.prototype.configureRegistrationTokenListener = function () {
        SyneriseModuleEmitter_1.SyneriseModuleEmitter.getEmitter().addListener(RNSyneriseNotifications.REGISTRATION_TOKEN_LISTENER_KEY, this.onRegistrationToken);
    };
    NotificationsModule.prototype.configureNotificationListener = function () {
        SyneriseModuleEmitter_1.SyneriseModuleEmitter.getEmitter().addListener(RNSyneriseNotifications.NOTIFICATION_LISTENER_KEY, this.onNotification);
    };
    NotificationsModule.prototype.configureRegistrationRequiredListener = function () {
        SyneriseModuleEmitter_1.SyneriseModuleEmitter.getEmitter().addListener(RNSyneriseNotifications.REGISTRATION_REQUIRED_LISTENER_KEY, this.onRegistrationRequired);
    };
    /**
    ...
    NotificationsModule.prototype.registerForNotifications = function (registrationToken, mobileAgreement, onSuccess, onError) {
        ...
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNSyneriseNotifications.registerForNotifications, [registrationToken, withMobileAgreement, mobileAgreementCopy], onSuccess, onError);
    };
    /**
    ...
    NotificationsModule.prototype.isSyneriseNotification = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isSyneriseNotification, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.isSyneriseSimplePush = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isSyneriseSimplePush, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.isSyneriseBanner = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isSyneriseBanner, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.isSilentCommand = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isSilentCommand, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.isSilentSDKCommand = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isSilentSDKCommand, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.isNotificationEncrypted = function (payload) {
        return SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.isNotificationEncrypted, [payload]);
    };
    /**
    ...
    NotificationsModule.prototype.decryptNotification = function (payload) {
        var decryptedPayloadObject = SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNSyneriseNotifications.decryptNotification, [payload]);
    ...
    NotificationsModule.prototype.handleNotification = function (payload, actionIdentifier) {
        if (DeviceUtils_1.DeviceUtils.isPlatformIOS()) {
            SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethod(RNSyneriseNotifications.handleNotification, [payload, actionIdentifier]);
        }
        else {
            SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethod(RNSyneriseNotifications.handleNotification, [payload]);
        }
    };
