...
var ClientModule = /** @class */ (function (_super) {
     ...
     * @param onError Function to be executed when the operation finishes unsuccessfully
     */
    ClientModule.prototype.requestAccountActivation = function (email, onSuccess, onError) {
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNClient.requestAccountActivation, [email], onSuccess, onError);
    };
    /**
     ...
     * @param onError Function to be executed when the operation finishes unsuccessfully
     */
    ClientModule.prototype.confirmAccountActivation = function (token, onSuccess, onError) {
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithCallback(RNClient.confirmAccountActivation, [token], onSuccess, onError);
    };
    /**
