...
var ClientModule = /** @class */ (function (_super) {
    ...
    ClientModule.prototype.signOutWithMode = function (mode) {
        var modeObject = ClientSignOutMode_1.ClientSignOutModeToString(mode);
        SyneriseModuleConnector_1.SyneriseModuleConnector.invokeMethodWithReturnValue(RNClient.signOutWithMode, [modeObject]);
    };
