...
var PromotionsApiQuery = /** @class */ (function (_super) {
    ...
    function PromotionsApiQuery() {
        ...
        _this.statuses = [];
        _this.types = [];
        _this.presentOnly = true;
        _this.checkGlobalActivationLimits = true;
        _this.includeVouchers = false;
        return _this;
    }
    PromotionsApiQuery.prototype.toObject = function () {
        return {
            ...
            checkGlobalActivationLimits: this.checkGlobalActivationLimits,
            includeVouchers: this.includeVouchers
        };
    };
