...
var Promotion = /** @class */ (function (_super) {
    ...
    function Promotion(modelObject) {
        ...
        _this.status = (0, PromotionStatus_1.PromotionStatusFromString)(modelObject.status);
        _this.type = (0, PromotionType_1.PromotionTypeFromString)(modelObject.type);
        ...
        _this.discountType = (0, PromotionDiscountType_1.PromotionDiscountTypeFromString)(modelObject.discountType);
        _this.discountValue = modelObject.discountValue;
        _this.discountMode = (0, PromotionDiscountMode_1.PromotionDiscountModeFromString)(modelObject.discountMode);
        ...
        _this.itemScope = (0, PromotionItemScope_1.PromotionItemScopeFromString)(modelObject.itemScope);
