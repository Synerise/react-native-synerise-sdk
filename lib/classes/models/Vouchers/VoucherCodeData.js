...
var VoucherCodeData = /** @class */ (function (_super) {
    __extends(VoucherCodeData, _super);
    function VoucherCodeData(modelObject) {
        ...
        if (modelObject.expireIn !== undefined) {
            _this.expireIn = new Date(modelObject.expireIn * 1000);
        }
        if (modelObject.redeemAt !== undefined) {
            _this.redeemAt = new Date(modelObject.redeemAt * 1000);
        }
        if (modelObject.assignedAt !== undefined) {
...
exports.VoucherCodeData = VoucherCodeData;
