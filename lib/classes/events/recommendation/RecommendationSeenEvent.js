...
var RecommendationSeenEvent = /** @class */ (function (_super) {
    ...
    function RecommendationSeenEvent(label, productId, productName, campaignId, campaignHash, parameters) {
        var _this = _super.call(this, label, 'recommendation.seen', parameters || {}) || this;
    ...
    RecommendationSeenEvent.prototype.setCategory = function (category) {
        this.parameters[Params.CATEGORY] = category;
    };
    RecommendationSeenEvent.prototype.setUrl = function (url) {
